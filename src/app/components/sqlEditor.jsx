...
//   const itemsPerPage = 17; // Number of rows per page

//   // CSV file URL
//   const CSV_URL = 'https://raw.githubusercontent.com/graphql-compose/graphql-compose-examples/master/examples/northwind/data/csv/order_details.csv';
...
//     // When Run is pressed, simply show the CSV contents
//     setResults([{
...
//           <span className="results-title">Table Name - Orders.csv</span>
//         </div>
//         <div className="results-content">
//           {isLoading ? (
//             <div className="no-results">
//               <h1>Loading CSV Data...</h1>
//               <p>Fetching and parsing orders.csv</p>
//             </div>
//           ) : results.length > 0 ? (
//             <>
...
import { Play, Database, X, Save, ChevronLeft, ChevronRight } from "lucide-react"
import Papa from "papaparse"
import "./sqlEditor.css"
...
const SqlEditor = () => {
  ...
  const handleRunQuery = () => {
    ...
    // When Run is pressed, show the CSV contents
    setResults([
      {
        columns: Object.keys(csvData[0] || {}),
        data: csvData.map((row) => Object.values(row)),
    ...
    const newHistory = [
      ...
      ...queryHistory,
    ].slice(0, 50) // Keep only the last 50 queries
    ...
    <div className="sql-editor-container">
      <div className="sql-editor-wrapper">
        ...
        <div className="editor-content">
          ...
          <div className="editor-actions">
            <button className="save-btn" onClick={handleSaveQuery} disabled={!query.trim()}>
              <Save size={16} /> Save
            </button>
